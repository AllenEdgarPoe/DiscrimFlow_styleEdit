...
class Glow(nn.Module):
    ...
    def forward(self, x, x_cond1, x_cond2, reverse=False):
        ...
        x_cond1, _ = self._pre_process(x_cond1)
        x_cond2, _ = self._pre_process(x_cond2)
...
class _FlowStep(nn.Module):
    def __init__(self, in_channels, cond_channels1, cond_channels2, mid_channels):
        ...
        self.coup1 = Coupling(in_channels // 2, cond_channels1, cond_channels2, mid_channels)
...
if __name__ == "__main__":
    ...
    cond1 = torch.randn(1, 3, 32, 32)*3
    cond2 = torch.randn(1,5)*3
    img = img.sigmoid()
